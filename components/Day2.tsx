...
const AgentCard = ({ agent, onClick }: { agent: AgentTemplate; onClick: () => void }) => (
  ...
  >
    ...
    <div className="mt-auto pt-2">
      <span className="text-[10px] font-bold uppercase tracking-widest text-pink-400 group-hover:text-pink-600 transition-colors">Ver prompt →</span>
    </div>
  </button>
);
      ...
      >
        ...
        <div className="flex-shrink-0 px-5 py-3 bg-amber-50 border-t border-amber-100">
          <p className="text-xs text-amber-700 text-center">
            💡 <strong>Tip:</strong> Copia este prompt y pégalo como instrucciones del sistema en ChatGPT, Gemini o Claude para crear tu propio agente.
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
              <div className="flex flex-wrap justify-between items-end gap-2">
                <label className="block text-base md:text-lg font-medium text-slate-700">Escribe tu prompt:</label>
                {isOptimized && (
        ...
        {mode === 'agent' && (
          <div className="space-y-6">
            <div className="bg-purple-50 border border-purple-100 rounded-2xl p-5">
              <h3 className="font-bold text-purple-800 text-sm uppercase tracking-wider mb-2">Plantilla para crear agentes de IA</h3>
              <p className="text-sm text-purple-700">Rellena los 3 campos para definir tu agente. La IA mejorará tu prompt convirtiéndolo en un system prompt profesional.</p>
            </div>
            ...
            {agentResult && (
              <div className="bg-[#0F172A] rounded-2xl overflow-hidden shadow-lg border border-slate-700">
                <div className="flex items-center justify-between px-4 py-3 bg-[#1e293b] border-b border-slate-700">
                  <div className="flex items-center gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-red-500" />
                    <div className="w-2.5 h-2.5 rounded-full bg-yellow-500" />
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Menú de Agentes Listos</span>
              <div className="flex-1 h-px bg-slate-200" />
            </div>
